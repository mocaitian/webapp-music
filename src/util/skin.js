...
let setSkinStyle = (skin) => {
    ...
    oldStyle ? document.head.replaceChild(style, oldStyle) : document.head.appendChild(style);//replaceChild替换子节点
}

console.log(localStore.getSkin())
setSkinStyle(skin[localStore.getSkin()]);
